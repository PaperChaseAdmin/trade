...
<div class="container">
  ...
  <div id="app" style="display:none">
    ...
    <div id="chart" style="background:var(--pc-surface);border:1px solid var(--pc-border);border-radius:var(--pc-radius-lg);padding:16px;margin-bottom:16px;height:300px"><canvas id="mainChart"></canvas></div>
