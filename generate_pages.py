...
<div class="container">
  ...
  <div id="app" style="display:none">
    ...
    <div id="chart" style="background:var(--pc-surface);border:1px solid var(--pc-border);border-radius:var(--pc-radius-lg);padding:8px;margin-bottom:16px;height:280px"><canvas id="mainChart" style="width:100%;height:100%"></canvas></div>
